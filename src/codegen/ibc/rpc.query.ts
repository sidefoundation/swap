...
export const createRPCQueryClient = async ({
  ...
  return {
    ...
    ibc: {
      applications: {
        atomic_swap: {
          v1: (await import("./applications/atomic_swap/v1/query.rpc.Query")).createRpcQueryExtension(client)
        },
        interchain_swap: {
          v1: (await import("./applications/interchain_swap/v1/query.rpc.Query")).createRpcQueryExtension(client)
        },
        transfer: {
