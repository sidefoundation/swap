...
export const createRPCMsgClient = async ({
  ...
  ibc: {
    applications: {
      atomic_swap: {
        v1: new (await import("./applications/atomic_swap/v1/tx.rpc.msg")).MsgClientImpl(rpc)
      },
      interchain_swap: {
        v1: new (await import("./applications/interchain_swap/v1/tx.rpc.msg")).MsgClientImpl(rpc)
      },
      transfer: {
