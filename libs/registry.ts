...
export interface CosmosRequestRegistry extends AbstractRegistry {
...
export interface Registry {
  [key: string]: AbstractRegistry;
}

export function withCustomAdapter<T extends AbstractRegistry>(
  target: T,
  source?: Partial<T>
): T {
